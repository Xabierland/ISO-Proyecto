...
# {
    ...
    do
        ...
        then
            cat $i | grep "sshd" | awk '{if ($6 == "Accepted" && $1 == "May" && $2 == "12") print "Status: ["$6"]\tAccount name: "$9"\tDate: "$1,$2", "$3}'
        elif [ $fileType = 'application/gzip;' ]
        then
            zcat $i | grep "sshd" | awk '{if ($6 == "Accepted" && $1 == "May" && $2 == "12") print "Status: ["$6"]\tAccount name: "$9"\tDate: "$1,$2", "$3}'
